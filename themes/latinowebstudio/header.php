...
echo '<a class="position-relative openModalBtn nav-toggle ml-4" style="padding-left:15px;width:45px;" id="search-icon" data-modal-id="searchMenu" title="search menu toggle">';

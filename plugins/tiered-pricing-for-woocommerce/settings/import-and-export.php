...
<table class="form-table">
	...
	if ('one' === $sub_section ) { // This will show  Import Settings
		...
		<?php printf('%1$s <a href="%2$s" download>%3$s</a> %4$s', esc_html__('Click here to dowload the', 'wtp'), '#', esc_html__('Sample CSV', 'wtp'), esc_html__('file for selected import type.', 'wtp')); ?>                        
				</span>
			</td>
		</tr>

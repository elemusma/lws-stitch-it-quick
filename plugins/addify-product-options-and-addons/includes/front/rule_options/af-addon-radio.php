...
foreach ( $options as $option_id ) {
	...
	<input type="radio" 
		...
		class="af_pao_options_radio_buttons af_pao_options_radio_buttons<?php echo esc_attr( $field_id ); ?> <?php echo esc_attr( $counter ); ?>_af_pao_options_radio_button_<?php echo esc_attr( $option_id ); ?> <?php echo esc_attr( $af_addon_front_dep_class ); ?>" 

...
class="addon_telephone_option <?php echo esc_attr( $af_addon_front_dep_class ); ?>" 
...
<?php if ( '1' == get_post_meta( $field_id, 'af_addon_limit_range_checkbox', true ) && ! empty( $max_limit_range ) ) { ?>

...
class FPDF_TPL extends PH_UPS_FPDF {
    /**
     * Array of Tpl-Data
     * @var array
     */
    ...
    function beginTemplate($x = null, $y = null, $w = null, $h = null) {
    	if (is_subclass_of($this, 'PH_UPS_TCPDF')) {
    ...
    function endTemplate() {
    	if (is_subclass_of($this, 'PH_UPS_TCPDF')) {
        	$args = func_get_args();
        	return call_user_func_array(array('PH_UPS_TCPDF', 'endTemplate'), $args);
        }
    ...
    public function SetFont($family, $style = '', $size = 0, $fontfile='', $subset='default', $out=true) {
        if (is_subclass_of($this, 'PH_UPS_TCPDF')) {
        	$args = func_get_args();
        	return call_user_func_array(array('PH_UPS_TCPDF', 'SetFont'), $args);
        }
    ...
    function Image(
        ...
        if (is_subclass_of($this, 'PH_UPS_TCPDF')) {
        	$args = func_get_args();
			return call_user_func_array(array('PH_UPS_TCPDF', 'Image'), $args);
        }
    ...
    function AddPage($orientation = '', $format = '', $keepmargins = false, $tocpage = false) {
    	if (is_subclass_of($this, 'PH_UPS_TCPDF')) {
        	$args = func_get_args();
        	return call_user_func_array(array('PH_UPS_TCPDF', 'AddPage'), $args);
        }
    ...
    function Link($x, $y, $w, $h, $link, $spaces = 0) {
        if (is_subclass_of($this, 'PH_UPS_TCPDF')) {
        	$args = func_get_args();
			return call_user_func_array(array('PH_UPS_TCPDF', 'Link'), $args);
        }
    ...
    function AddLink() {
    	if (is_subclass_of($this, 'PH_UPS_TCPDF')) {
        	$args = func_get_args();
			return call_user_func_array(array('PH_UPS_TCPDF', 'AddLink'), $args);
        }
    ...
    function SetLink($link, $y = 0, $page = -1) {
    	if (is_subclass_of($this, 'PH_UPS_TCPDF')) {
        	$args = func_get_args();
			return call_user_func_array(array('PH_UPS_TCPDF', 'SetLink'), $args);
        }

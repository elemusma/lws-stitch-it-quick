 ...
 * Plugin URI: http://www.woocommerce.com/products/firstdata/
 * Documentation URI: https://woocommerce.com/document/clover/
...
class WC_First_Data_Loader {
	...
	/** @var \WC_First_Data_Loader single instance of this class */
	...
	public function init_plugin() {
		...
		require_once( plugin_dir_path( __FILE__ ) . 'class-wc-first-data.php' );
	...
	/**
	 * Displays any admin notices added with SV_WC_First_Data_Loader::add_admin_notice()
	 *
	 * @since 4.4.0
	 */
	...
	/**
	 * Gets the main SV_WC_First_Data_Loader instance.
	 *
	 * Ensures only one instance can be loaded.
	 *
	 * @since 4.4.0
	 *
	 * @return WC_First_Data_Loader
	 */

...
if ( ! class_exists( 'YITH_WAPO_Addon_Premium' ) ) {
    ...
    class YITH_WAPO_Addon_Premium extends YITH_WAPO_Addon {
        ...
        public function get_grid_rules() {
            ...
            $width_types = array( 'color', 'number' );

            if ( in_array( $this->type, $width_types, true ) ) {
                $width_percentage = wp_is_mobile() ? $width : $width / $per_row;
            } else {
                $width_percentage = wp_is_mobile() ? 100 : $width / $per_row;
            }
        ...
        /**
         * Get the product name and include variation attributes for product variations.
         *
            ...
            if ( $product instanceof WC_Product ) {
                ...
                if ( $product instanceof WC_Product_Variation ) {
                    ...
                    if ( $show_variation_att ) {
                        ...
                        $name  = $name . ' - ' . urldecode( $var_attributes );
                    }
                }
            }

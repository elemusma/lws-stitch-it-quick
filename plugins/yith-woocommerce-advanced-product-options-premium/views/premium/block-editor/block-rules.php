...
<div id="block-rules">
            ...
            if ( empty( $show_in_products ) && isset( $_REQUEST['block_rule_show_in_products'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				...
				yith_plugin_fw_get_field(
					array(
						...
						'data'     => apply_filters ('yith_wapo_block_rule_show_in_products_data' , array(
            ...
            <?php
                yith_plugin_fw_get_field(
                    array(
                        ...
                        'data'     => apply_filters ('yith_wapo_block_rule_exclude_products_data' , array(
                            'action'   => 'woocommerce_json_search_products_and_variations',
                            'security' => wp_create_nonce( 'search-products' ),
                        ) ),
                    ),
    ...
    <div class="field-wrap">
        ...
        <div class="field block-option">
            ...
            } elseif ( isset( $_REQUEST['block_rule_show_to'] ) && ! empty( $_REQUEST['block_rule_show_to'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                $block_rule_show_to = $_REQUEST['block_rule_show_to']; // phpcs:ignore WordPress.Security.NonceVerification.Recommended
            }

...
! defined( 'YITH_WAPO_VERSION' ) && define( 'YITH_WAPO_VERSION', '4.13.0' );
! defined( 'YITH_WAPO_SCRIPT_VERSION' ) && define( 'YITH_WAPO_SCRIPT_VERSION', '4.13.0' );
	...
	function yith_wapo_init() {
		if ( function_exists( 'WC' ) ) {
			...
			if ( defined( 'YITH_WAPO_PREMIUM' ) && YITH_WAPO_PREMIUM ) {
				...
				require_once 'includes/class-yith-wapo-cart-premium.php';
...
if ( defined( 'YITH_WAPO_PREMIUM' ) && is_dir( YITH_WAPO_INCLUDES_PATH . '/wc-blocks' ) ) {

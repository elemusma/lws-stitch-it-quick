...
class Inflectible
{
    ...
    {
        (yield new Transformation(new Pattern('(s)tatuses$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2tatus'));
        (yield new Transformation(new Pattern('(s)tatus$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2tatus'));
        (yield new Transformation(new Pattern('(c)ampus$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2ampus'));
        (yield new Transformation(new Pattern('^(.*)(menu)s$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2'));
        ...
        (yield new Transformation(new Pattern('(m)ovies$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2ovie'));
        (yield new Transformation(new Pattern('(s)eries$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2eries'));
        ...
        (yield new Transformation(new Pattern('(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2sis'));
        ...
        (yield new Transformation(new Pattern('(p)eople$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2erson'));
        (yield new Transformation(new Pattern('(m)en$'), '\\1an'));
        (yield new Transformation(new Pattern('(c)hildren$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2hild'));
        (yield new Transformation(new Pattern('(f)eet$'), '\\1oot'));
        (yield new Transformation(new Pattern('(n)ews$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2ews'));
    ...
    {
        (yield new Transformation(new Pattern('(s)tatus$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2tatuses'));
        (yield new Transformation(new Pattern('(quiz)$'), '\\1zes'));
        (yield new Transformation(new Pattern('^(ox)$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2en'));
        ...
        (yield new Transformation(new Pattern('(?:([^f])fe|([lr])f)$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2ves'));
        ...
        (yield new Transformation(new Pattern('(buffal|her|potat|tomat|volcan)o$'), 'Barn2\\Plugin\\WC_Product_Options\\Dependencies\\1\\2oes'));

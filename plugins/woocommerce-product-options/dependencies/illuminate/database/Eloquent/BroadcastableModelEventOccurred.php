...
use Barn2\Plugin\WC_Product_Options\Dependencies\Illuminate\Broadcasting\InteractsWithSockets;
use Barn2\Plugin\WC_Product_Options\Dependencies\Illuminate\Broadcasting\PrivateChannel;
use Barn2\Plugin\WC_Product_Options\Dependencies\Illuminate\Contracts\Broadcasting\ShouldBroadcast;
use Barn2\Plugin\WC_Product_Options\Dependencies\Illuminate\Queue\SerializesModels;
/** @internal */
class BroadcastableModelEventOccurred implements ShouldBroadcast
{
    ...
    public function broadcastOn()
    {
        ...
        return \Barn2\Plugin\WC_Product_Options\Helpers::collect($channels)->map(function ($channel) {
    ...
    {
        $default = \Barn2\Plugin\WC_Product_Options\Helpers::class_basename($this->model) . \ucfirst($this->event);
